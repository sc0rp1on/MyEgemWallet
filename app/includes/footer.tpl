...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <a href="/"><img src="images/EGEM-logo.png" height="45px" width="auto" alt="EGEM Wallet" class="footer--logo"/></a>
   ...
   <!-- <section class="footer--cent">
    ...
    <section class="footer--righ">
      ...
      <p>
        <a aria-label="support email" href="mailto:info@egem.io" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Email support: info@egem.io
        </a>
      </p>
      <p>
      ...
      <p>
        <a aria-label="my egem wallet chrome extension" href="https://chrome.google.com/webstore/detail/myetherwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm?hl=en" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          MyEgem Chrome Extension
        </a>
      </p>
